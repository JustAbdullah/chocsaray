...
import 'package:chocsarayi/screens/menu/widget/delete_confirmation_dialog.dart';
        ...
        Expanded(
          child: ListView(padding: EdgeInsets.zero, physics: BouncingScrollPhysics(), children: [
            ...
            ListTile(
              ...
              leading: Image.asset("assets/icon/wallet.png", width: 20, height: 20, color: Theme.of(context).textTheme.bodyLarge!.color),
            ...
            if(user.isNotEmpty)
              ListTile(
                ...
                leading: Image.asset("assets/icon/gift.png", width: 20, height: 20, color: Theme.of(context).textTheme.bodyLarge!.color),
            ...
            if(user.isNotEmpty)
              ListTile(
                ...
                leading: Image.asset("assets/icon/table.png", width: 20, height: 20, color: Theme.of(context).textTheme.bodyLarge!.color),
            ...
            if(user.isEmpty)
              ListTile(
                ...
                leading: Icon(Icons.login, size: 20, color: Theme.of(context).textTheme.bodyLarge!.color),
            ...
            ListTile(
              ...
              leading: Icon(Icons.location_city, size: 20, color: Theme.of(context).textTheme.bodyLarge!.color),
            ...
            ListTile(
              ...
              leading: Icon(Icons.contact_support, size: 20, color: Theme.of(context).textTheme.bodyLarge!.color),
            ...
            ListTile(
              ...
              leading: Icon(Icons.rule, size: 20, color: Theme.of(context).textTheme.bodyLarge!.color),
              title: Text('سياسة الخصوصية', style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
            ),
            if(user.isNotEmpty)
              ListTile(
                onTap: () {
                ...
                leading: Image.asset(Images.log_out, width: 20, height: 20, color: Theme.of(context).textTheme.bodyLarge!.color),
