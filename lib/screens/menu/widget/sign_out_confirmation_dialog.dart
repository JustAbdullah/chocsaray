    ...
    return Dialog(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Padding(
          ...
          child: Text('هل انت متأكد', style: rubikBold, textAlign: TextAlign.center),
        ),
        ...
        Row(children: [
          ...
          Expanded(child: InkWell(
            ...
            child: Container(
              ...
              child: Text('نعم', style: rubikBold.copyWith(color: ColorResources.COLOR_PRIMARY)),
            ),
          )),
          ...
          Expanded(child: InkWell(
            ...
            child: Container(
              ...
              child: Text('لا',  style: rubikBold.copyWith(color: Colors.white)),
            ),
          )),
